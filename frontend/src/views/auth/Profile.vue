                    ...
                    <Form @submit="update" :validation-schema="userFormSchema">
                        <div class="row justify-content-center">
                            <div class="col-lg-6 form-group">
                                ...
                                <Field class="form-control rounded-0" id="name" name="name" v-model="user.name" type="text" />
                                <ErrorMessage class="error-feedback" name="name" />
                            </div>

                            <div class="col-lg-6 form-group">
                                <label for="auth">Quyền hạn</label>
                                <select class="form-control rounded-0 " name="auth" v-model="user.isAdmin" readonly disabled>
                            ...
                            <div class="col-lg-6 form-group">
                                ...
                                <Field class="form-control rounded-0" id="phone" name="phone" v-model="user.phone" type="text" />
                        ...
                        <div class="row justify-content-center">
                            <div class=" col-12 form-group">
                                ...
                                <button class="btn position-absolute" type="button" 
                                    @click="toggleShowPassword(0)" style="right: 15px; top: 32px;">
                            ...
                            <div class=" col-12 form-group">
                                ...
                                <Field class="form-control rounded-0" id="re-password" name="re-password" min="6" max="16"
                                :type="showPassword[2] ? 'text' : 'password'" v-model="rePassword" />
                                <button class="btn position-absolute" type="button" 
                                    @click="toggleShowPassword(2)" style="right: 15px; top: 32px;">
